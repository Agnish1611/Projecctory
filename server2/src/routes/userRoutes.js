...
import { validateCreateRequest, validateUpdateRequest, validateFriendRequest, verifyJWT } from "../middlewares/userMiddleware.js";
...
router.patch('/', verifyJWT, validateUpdateRequest, updateUser);
